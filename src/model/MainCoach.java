...
public class MainCoach extends Coach implements SoccerWorld {
     ...
     * @param status is the boolean that know us if the player is active or not
     * in the club
     */
    ...
    /**
     * Description This method get number of championshitps thatthe main coach
     * was win
     *
     * @return numberChampionships is the number of the main coach´s
     * championships that he win
     */
    ...
    /**
     * Description This method sets number of championshitps thatthe main coach
     * was win
     *
     * @param numberChampionships is the number of the main coach´s
     * championships that he win
     */
    ...
    /**
     * Description This method calculate the price of the maincoach in the
     * market
     */
    @Override
