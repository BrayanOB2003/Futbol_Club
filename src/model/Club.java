...
public class Club {
    ...
    public Club() {
        ...
        this.nit = 234832;
        this.date = "12/02/1998";
        this.name = "Super Campeones";
        teams = new Team[AMOUNT];
        Team teamA = new Team("Newpi");
        Team teamB = new Team("NewTeam");
        teams[0] = teamA;
        teams[1] = teamB;
     ...
     *
     * @return dressinRoomA is the matriz that save the position of the players
     * in the roomA
     */
     ...
     *
     * @param dressinRoomA is the matriz that save the position of the players
     * in the roomA
     */
     ...
     *
     * @return dressinRoomB is the matriz that save the position of the players
     * in the roomB
     */
     ...
     * @param averageMark is the average mark that help us to know how good is a
     * player
     ...
     * @param status is the status of the employee true or false depends if the
     * employee is active in th eclub
     ...
     * Description This method ShowemployeeInfoo
     *
     * @param wasPlayer is the boolean that confirms if the coach was or not a
     * player
     ...
     *
     * @return dismiss is the text that inform to user if the employee was or
     * not was dismiss
     */
     ...
     *
     * @param team int with th eidentificator to know if is team A or team B AND
     * 0 if is team A OR 1 if team B
     * @param date String with the date of the math
     * @param tactic int is the number of give us what tactic have the team to
     * the match
     ...
     * @param status boolean with the confirmation if the player is active or
     * inactive for the club
     * @return info that contain all employees information
     */
     ...
     *
     * @param employee int with the type of employee
     * @param teamsInCharge int with the number of teams that the coach have in
     * charge
     * @param numberChampionship int with the quantity of champions have the
     * coach
     * @param yearsExperience int quantity with the years experience of the
     * coach
     * @param salary int is the salary that the coach gets
     * @param status boolean with the confirmation if the coach is active or
     * inactive for the club
     * @return info that contain all employees information
     */
     ...
     *
     * @param player is the identificator the player to add to the dressing
     * roomA
     ...
     *
     * @return info returns the matriz imprint with the info that the dressing
     * rooms
     */
     ...
     *
     * @return info returns the matriz imprint with the info that the show
     * office sector
     */
     ...
     * @return find returns the information of the position of playe in dressing
     * room if is in A or B
     */
     ...
     * @return find returns the information of the position of coach in the
     * dressing room
     */
